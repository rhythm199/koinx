...
const Sentiments = () => {
  return (
    <div className="bg-white h-max rounded-lg my-5 lg:p-6 p-3" id="Sentiments">
      <div>
        ...
        <div className="flex flex-row py-4 gap-x-4 overflow-x-auto">
          <div className="min-w-[15em] lg:w-[545px]  bg-[#E8F4FD] min-h-[204px] rounded-xl overflow-y-hidden">
            <div className="p-4 flex">
              ...
              <div className="ml-2 w-[calc(100%-3rem)]">
                <div className="lg:text-m text-s font-medium text-[#191C1F] whitespace-normal">
                  Lorem ipsum dolor sit amet consectetur. Dui vel quis dignissim
                  mattis enim tincidunt.
                </div>
                <div className="lg:text-m text-s font-normal text-[#3E5765] whitespace-normal mt-2 over">
          ...
          <div className=" min-w-[15em] lg:w-[545px] bg-[#EBF9F4] min-h-[204px] rounded-xl lg:ml-4  overflow-y-hidden">
            <div className="p-4 flex">
              ...
              <div className="ml-2 w-[calc(100%-3rem)]">
                ...
                <div className="hidden lg:flex relative">
                  <div className="absolute top-10 left-full transform -translate-y-1/2 -ml-8 bg-white p-4 rounded-full cursor-pointer">
        ...
        <div className="mb-6">
          ...
          <div className="flex mt-2">
            <div className="text-5xl font-medium bg-[#EBF9F4] text-[#0FBA83] lg:px-10 lg:py-12 px-8 py-6 rounded-full items-center flex">
