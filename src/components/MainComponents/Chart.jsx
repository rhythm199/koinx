  ...
  return (
    <div className="bg-white h-max rounded-lg my-5 p-6">
      <div className="flex items-center">
        <div id='technical'>
          <img src={btc} className="w-9" alt="Bitcoin" />
        </div>
        <div className="text-2xl font-bold text-[#0B1426] pl-2">
          Bitcoin
        </div>
        <div className="text-md font-bold text-[#5D667B] pl-2">BTC</div>
      ...
      <div className="lg:flex mb-4 justify-between">
        <div className="ls:text-lg text-md font-semibold text-[#0B1426]">
