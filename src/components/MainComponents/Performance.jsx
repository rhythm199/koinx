      ...
      <div>
        ...
        <div className="py-4 mt-2">
          <div className="flex justify-between ">
            ...
            <div className="w-[850px] h-2">
              <div className="bg-gradient-to-r from-red-500 via-orange-300 via-yellow-400 to-green-300 h-full rounded-2xl mt-7"></div>
              <div className="relative top-1/2 left-[75%] transform translate-x-4 -translate-y-1/2 mt-4">
                <svg
                  viewBox="0 0 100 100"
          ...
          <div className="lg:flex mb-8">
            <div className="w-full lg:w-1/2 mr-10 mt-3">
              <div className="flex justify-between py-5 border-b-2 border-[#D3E0E6]">
                <div className="text-[#768396] text-m font-semibold">
                  Bitcoin Price
                </div>
                <div className="text-[#111827] text-m font-semibold mr-4">
                  $16,815.46
                </div>
              </div>
              <div className="flex justify-between py-5 border-b-2 border-[#D3E0E6]">
            ...
            <div className=" w-full lg:w-1/2  lg:ml-10 mt-3">
              ...
              <div className="flex justify-between py-3 border-b-2 border-[#D3E0E6] items-center">
                ...
                <div className="text-[#111827] text-m font-semibold mr-4 -p-2">
                  <div className="text-end">
